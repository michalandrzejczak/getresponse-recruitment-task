...
function WeekSlider({week, max}) {
    ...
    return (
        <div className="week-slider_wrapper">
            <span style={weekState !== 1 ? {} : {visibility: 'hidden'}} className="week-slider_arrow-button"
            ...
            <span style={weekState !== max ? {} : {visibility: 'hidden'}} className="week-slider_arrow-button"
                  onClick={nextWeek}>
                <svg xmlns="http://www.w3.org/2000/svg" width="9" height="16" viewBox="0 0 9 16"><g><g><path
